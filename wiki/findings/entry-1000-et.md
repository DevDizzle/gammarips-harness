...
The engine's tested reference entry is **10:00 ET**: it skips the opening auction chaos
and the first half-hour's spread blowout while still riding the morning OI build from the
overnight sweep. Earlier entries tested worse; this is adopted policy rather than a large
measured edge.
